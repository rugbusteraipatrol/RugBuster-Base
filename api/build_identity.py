...
On this service that mattered in its own way: `tron-api`, a sibling of this
one, served July code for two months behind a green /health because it tracked
a stale branch, and nothing in any response said so.
